...
import { GreConsultaJob } from './jobs/gre-consulta.job';
...
@Module({
  ...
  providers: [DocumentosSalidaLogic, DocumentosSalidaModel, DocSalidaDespatchMapper, DocSalidaPdfGenerator, GreConsultaJob],
