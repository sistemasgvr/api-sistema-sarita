BEGIN;
ALTER TABLE doc_salida ADD COLUMN IF NOT EXISTS gre_extra jsonb;
ALTER TABLE doc_salida ADD COLUMN IF NOT EXISTS id_empresa integer REFERENCES gen_empresa(id);
