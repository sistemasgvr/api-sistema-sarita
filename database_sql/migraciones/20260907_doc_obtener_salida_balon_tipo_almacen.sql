-- ============================================================
-- Migración: doc_obtener_salida expone tipo y almacén del cilindro
-- Fecha: 2026-09-07
--
-- El detalle propio de una orden de salida devolvía solo el código del balón.
-- La card del detalle muestra código · tipo · almacén, igual que el selector,
-- así que esos dos datos tenían que salir de la misma consulta.
--
-- Solo se agregan dos columnas al JSON del detalle PROPIO; el resto del
-- documento y los detalles de VENTA/PRESTAMO no cambian.
--
-- Aplicar con:
--   node database_sql/scripts/apply-migration.js database_sql/migraciones/20260907_doc_obtener_salida_balon_tipo_almacen.sql
-- ============================================================
