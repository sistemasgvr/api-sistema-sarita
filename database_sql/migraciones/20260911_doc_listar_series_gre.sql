-- Series de guía de remisión como select con correlativo automático (modal
-- "Convertir a GRE"), al estilo de boletas: nueva función que lista las series
-- ya usadas por tipo de guía (T### remitente / V### transportista) con su
-- siguiente número. No modifica tablas ni otras funciones.
--
-- ⚠️ NO EJECUTAR sin revisión — aplicar con apply-migration.js cuando el
-- usuario lo confirme:
--   node database_sql/scripts/apply-migration.js database_sql/migraciones/20260911_doc_listar_series_gre.sql

-- ===== database_sql/funciones/documentos-salida/doc_listar_series_gre.sql =====
