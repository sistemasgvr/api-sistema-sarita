-- ============================================================
-- Migracion: hora de inicio obligatoria al crear recojo
-- Fecha: 2026-09-09
--
-- Aplicar con:
--   node database_sql/scripts/apply-migration.js database_sql/migraciones/20260909_age_crear_recojo_hora_inicio.sql
-- ============================================================
