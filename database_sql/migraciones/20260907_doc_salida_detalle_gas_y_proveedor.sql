-- ============================================================
-- Migración: doc_obtener_salida — gas del cilindro y documento del proveedor
-- Fecha: 2026-09-07
--
-- 1) El detalle propio expone el gas de cada balón (id/nombre), su número de
--    serie y su ficha vigente. Con eso la orden de salida puede ofrecer
--    "Asociar lote y protocolo" cuando todos sus cilindros son del mismo gas.
--
-- 2) La cabecera expone documento_proveedor: en recarga/retorno de planta
--    externa el proveedor ES el destinatario y el PDF imprime su documento.
--
-- No cambia ninguna tabla.
--
-- Aplicar con:
--   node database_sql/scripts/apply-migration.js database_sql/migraciones/20260907_doc_salida_detalle_gas_y_proveedor.sql
-- ============================================================
