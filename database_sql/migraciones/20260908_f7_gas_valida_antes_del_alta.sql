-- ============================================================
-- Migración: la validación del retorno corre antes de dar de alta cilindros
-- Fecha: 2026-09-08
--
-- com_registrar_balones_compra comprobaba "¿el retorno está marcado?" dentro
-- del bucle, después de crear el cilindro. Al rechazar, los cilindros ya
-- procesados quedaban en el libro. Ahora se valida sobre el lote completo antes
-- de tocar nada.
--
-- Aplicar con:
--   node database_sql/scripts/apply-migration.js database_sql/migraciones/20260908_f7_gas_valida_antes_del_alta.sql
-- ============================================================
