...
FROM (
    VALUES
        ...
        ('categorias.restaurar', 'Restaurar categorías de producto eliminadas'),
        ...
        ('sub_categorias.restaurar', 'Restaurar subcategorías de producto eliminadas'),
        ...
        ('stock.restaurar', 'Restaurar registros de stock eliminados'),
