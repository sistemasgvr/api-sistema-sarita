...
-- Function: bal_eliminar_recarga_planta
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.550Z
DROP FUNCTION IF EXISTS bal_eliminar_recarga_planta(p_id integer, p_id_usuario_auditoria integer);

CREATE OR REPLACE FUNCTION bal_eliminar_recarga_planta(p_id integer, p_id_usuario_auditoria integer DEFAULT NULL::integer)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
