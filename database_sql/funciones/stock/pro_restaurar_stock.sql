...
-- Function: pro_restaurar_stock
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.794Z
DROP FUNCTION IF EXISTS pro_restaurar_stock(p_id integer, p_id_usuario_auditoria integer);

CREATE OR REPLACE FUNCTION pro_restaurar_stock(p_id integer, p_id_usuario_auditoria integer DEFAULT NULL::integer)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
