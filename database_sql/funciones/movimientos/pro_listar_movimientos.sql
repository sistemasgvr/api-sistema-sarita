...
-- Function: pro_listar_movimientos
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.784Z
DROP FUNCTION IF EXISTS pro_listar_movimientos(p_busqueda character varying, p_limite integer, p_offset integer, p_id_producto integer, p_id_almacen integer, p_id_tipo_movimiento integer, p_fecha_desde date, p_fecha_hasta date);

CREATE OR REPLACE FUNCTION pro_listar_movimientos(p_busqueda character varying DEFAULT ''::character varying, p_limite integer DEFAULT 10, p_offset integer DEFAULT 0, p_id_producto integer DEFAULT NULL::integer, p_id_almacen integer DEFAULT NULL::integer, p_id_tipo_movimiento integer DEFAULT NULL::integer, p_fecha_desde date DEFAULT NULL::date, p_fecha_hasta date DEFAULT NULL::date)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
