-- Alquileres ACTIVOS cuya fecha de vencimiento (periodo vigente o fecha_fin_pactada) ya pasó.
CREATE OR REPLACE FUNCTION bal_listar_alquileres_vencidos_notificar(
