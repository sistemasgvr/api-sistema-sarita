...
-- Function: gen_listar_provincias
-- Overloads: 1
-- Generated: 2026-09-03T16:50:38.962Z
DROP FUNCTION IF EXISTS gen_listar_provincias(p_id_departamento integer);

CREATE OR REPLACE FUNCTION gen_listar_provincias(p_id_departamento integer DEFAULT NULL::integer)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
