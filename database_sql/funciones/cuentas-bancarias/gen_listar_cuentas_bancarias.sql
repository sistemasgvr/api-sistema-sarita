...
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.728Z
...
CREATE OR REPLACE FUNCTION gen_listar_cuentas_bancarias(p_solo_activos integer DEFAULT NULL::integer, p_buscar character varying DEFAULT ''::character varying, p_limite integer DEFAULT 10, p_offset integer DEFAULT 0, p_id_cliente integer DEFAULT NULL::integer)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
