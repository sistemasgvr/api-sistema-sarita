...
-- Function: cli_obtener_por_id_cliente
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.624Z
DROP FUNCTION IF EXISTS cli_obtener_por_id_cliente(p_id integer);

CREATE OR REPLACE FUNCTION cli_obtener_por_id_cliente(p_id integer)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
