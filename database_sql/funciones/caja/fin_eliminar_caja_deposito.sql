...
-- Function: fin_eliminar_caja_deposito
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.676Z
DROP FUNCTION IF EXISTS fin_eliminar_caja_deposito(p_id integer, p_id_usuario integer);

CREATE OR REPLACE FUNCTION fin_eliminar_caja_deposito(p_id integer, p_id_usuario integer DEFAULT NULL::integer)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
