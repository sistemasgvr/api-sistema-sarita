...
-- Function: pro_restaurar_sub_categoria
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.795Z
DROP FUNCTION IF EXISTS pro_restaurar_sub_categoria(p_id integer, p_id_usuario_auditoria integer);

CREATE OR REPLACE FUNCTION pro_restaurar_sub_categoria(p_id integer, p_id_usuario_auditoria integer DEFAULT NULL::integer)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
