-- Balones alquilados a clientes. Filtro opcional por cliente (ubicación).

DROP FUNCTION IF EXISTS dash_balones_alquilados();

CREATE OR REPLACE FUNCTION dash_balones_alquilados(
