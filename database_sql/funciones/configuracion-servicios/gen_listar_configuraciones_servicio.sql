...
-- Function: gen_listar_configuraciones_servicio
-- Overloads: 1
-- Generated: 2026-09-02T21:31:03.726Z
DROP FUNCTION IF EXISTS gen_listar_configuraciones_servicio(p_busqueda character varying, p_limite integer, p_offset integer);

CREATE OR REPLACE FUNCTION gen_listar_configuraciones_servicio(p_busqueda character varying DEFAULT ''::character varying, p_limite integer DEFAULT 10, p_offset integer DEFAULT 0)
 RETURNS json
 LANGUAGE plpgsql
AS $function$
DECLARE
